...
function TRG_addAutomationManagementMenu_() {
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addItem('Phase22 근본복구 미리보기', 'AUTOMATION_previewPhase22RootRecovery')
    .addItem('Phase22 근본복구 실행', 'AUTOMATION_executePhase22RootRecovery')
    ...
    .addSeparator()
    .addItem('점검일정 동기화 미리보기', 'INSPSYNC_previewInspectionScheduleSync')
    .addItem('점검일정 → 마스터 일괄 반영', 'INSPSYNC_syncInspectionScheduleNow')
    .addItem('점검일정 동기화 로그 열기', 'INSPSYNC_showInspectionScheduleSyncLog')
    .addItem('점검일정 동기화 상태 열기', 'INSPSYNC_showInspectionScheduleSyncState')
    .addSeparator()
    .addItem('선임완료 동기화 미리보기', 'APPTSYNC_previewAppointmentStatusSync')
    .addItem('선임신고 현황 → 마스터 일괄 반영', 'APPTSYNC_syncAppointmentStatusesNow')
    .addItem('선임완료 동기화 로그 열기', 'APPTSYNC_showAppointmentStatusSyncLog')
    ...
    .addItem('장애 Discord 웹훅 적용', 'AUTOMATION_applyHealthDiscordWebhookPhase24')
    .addItem('장애 Discord 웹훅 테스트', 'AUTOMATION_testHealthDiscordWebhook')
    ...
    .addSeparator()
    .addItem('Phase21 장애 복구 미리보기', 'AUTOMATION_previewPhase21Recovery')
    .addItem('Phase21 장애 복구 실행', 'AUTOMATION_executePhase21Recovery')
